...
<body>
	...
	<div class="heading">
		<button class="viewlog btn-back"
			onclick="document.location.href='index.jsp';">Back</button>
	...
	<c:if test="${requestScope.ErrorMessage == null}">
		<c:if test="${velocityResponse.bankcardTransactionResponse != null}">
			...
			<div class="sub-heading">
				...
				<label style="font-weight: bold; padding-left: 20px;">Date:</label>
				<label><c:out
						value="${velocityResponse.bankcardTransactionResponse.serviceTransactionDateTime.date}" /></label>
				<div class="clear"></div>

				<label style="font-weight: bold; padding-left: 20px;">Time:</label>
				<label><c:out
		...
		<c:if test="${velocityResponse.bankcardCaptureResponse != null}">
			...
			<div class="sub-heading">
				...
				<label
					style="font-weight: bold; margin-left: 22px; padding-bottom: 12px;">NetAmount:</label>
				...
				<label style="font-weight: bold; margin-left: 22px;">Count:</label>
				<label><c:out
				...
				<label
					style="font-weight: bold; margin-left: 18px; padding-bottom: 12px;">SaleTotals:</label>
				<div class="clear"></div>
		...
		<c:if test="${velocityResponse.errorResponse != null}">
			...
			<div class="sub-heading">
				...
				<c:forEach
					items="${velocityResponse.errorResponse.validationErrors.validationErrorList}"
					var="current">
					<label style="font-weight: bold; padding-left: 20px;"> <span>-</span>
						&nbsp; ValidationError
					</label>
					<div class="clear"></div>
					<p>
						<label style="font-weight: bold; padding-left: 40px;"><span>-</span>
							&nbsp;RuleKey</label> <label> : <c:out value="${current.ruleKey}" /></label>
					<div class="clear"></div>
					<label style="font-weight: bold; padding-left: 40px;"><span>-</span>
						&nbsp;RuleLocationKey</label>
					<label> : <c:out value="${current.ruleLocationKey}" /></label>
					<div class="clear"></div>
					<label style="font-weight: bold; padding-left: 40px;"><span>-</span>
						&nbsp;RuleMessage</label>
					<label> : <c:out value="${current.ruleMessage}" /></label>
					<div class="clear"></div>
					<label style="font-weight: bold; padding-left: 40px;"><span>-</span>
						&nbsp;TransactionId</label>
					<label> : <c:out value="${current.transactionId}" /></label>
					<div class="clear"></div>
					</p>
				</c:forEach>
				</label>
		...
		<c:if test="${velocityResponse.transactionDetailList != null}">
			<div class="sub-heading">
				...
				<c:forEach items="${velocityResponse.transactionDetailList}"
					var="current">
					...
					<div class="clear"></div>
					<label style="font-weight: bold">TransactionId:</label>
					<label><c:out
							value="${current.transactionInformation.transactionId}" /></label>
					<div class="clear"></div>
					<label style="font-weight: bold">ApprovalCode:</label>
					<label><c:out
					...
					<div class="clear"></div>
					<label style="font-weight: bold">BatchId:</label>
					<label><c:out
							value="${current.transactionInformation.batchId}" /></label>
					<div class="clear"></div>

					<div class="clear"></div>
					<label style="font-weight: bold">CapturedAmount:</label>
					<label><c:out
							value="${current.transactionInformation.capturedAmount}" /></label>
					<div class="clear"></div>

					<div class="clear"></div>
					<label style="font-weight: bold">CaptureDateTime:</label>
					<label><c:out
							value="${current.transactionInformation.captureDateTime}" /></label>
					<div class="clear"></div>

					<div class="clear"></div>
					<label style="font-weight: bold">CaptureStates:</label>
					<label><c:out
							value="${current.transactionInformation.captureState}" /></label>
					<div class="clear"></div>

					<div class="clear"></div>
					<label style="font-weight: bold">CaptureStatusMessage:</label>
					<label><c:out
							value="${current.transactionInformation.captureStatusMessage}" /></label>
					<div class="clear"></div>

					<div class="clear"></div>
					<label style="font-weight: bold">MaskedPAN:</label>
					<label><c:out
					...
					<div class="clear"></div>
					<label style="font-weight: bold">StoredValueData:</label>
					<label><c:out
							value="${current.transactionInformation.storedValueData}" /></label>
					<div class="clear"></div>

					<div class="clear"></div>
					<label style="font-weight: bold">TransactionClassTypePair:</label>
					<label><c:out
							value="${current.transactionInformation.transactionClassTypePair}" /></label>
					<div class="clear"></div>

					<div class="clear"></div>
					<label style="font-weight: bold">TransactionStates:</label>
					<label><c:out
							value="${current.transactionInformation.transactionState}" /></label>
					<div class="clear"></div>

					<div class="clear"></div>
					<label style="font-weight: bold">TransactionTimestamp:</label>
					<label><c:out
		...
		<c:if test="${velocityResponse.arrayOfResponse != null}">
			...
			<div class="sub-heading">
				...
				<label style="font-weight: bold; padding-left: 20px;">NetAmount:</label>
				<label><c:out
