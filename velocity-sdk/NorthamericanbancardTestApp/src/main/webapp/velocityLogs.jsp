...
<body>
	<div class="heading">
		<button class="btn-back"
			onclick="document.location.href='result.jsp';">Back</button>
		...
		<div class="request-box">
			<ul>
				...
				<c:if test="${txnName != null}">
					<li><a href="#tabs-2">${txnName} Request & Response</a></li>
				</c:if>
			</ul>
		</div>
	</div>
	<div id="tabs-1">
		<div id="request">
			...
			<div id="reqdata">${identityToken}</div>
		</div>
		<div id="response">
			<div id="resheader">Response of SignOn SessionToken</div>
			<div id="resdata">${sessionToken}</div>
		</div>
