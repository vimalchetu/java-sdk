...
/**
 * This model class defines the entities for TransactionData
 * 
 * @author vimalk2
...
public class TransactionData {
	...
	public String getIsQuasiCash() {
		return isQuasiCash;
	}

	public void setIsQuasiCash(String isQuasiCash) {
