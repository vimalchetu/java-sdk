...
/**
 * This class defines the attributes for PINDebitSaleTotals
 * 
 * @author Vimal Kumar
 * @date 13-04-2015
 */
...
@XmlType(name = "PINDebitSaleTotals", propOrder = {})
@XmlRootElement(name = "PINDebitSaleTotals", namespace = "http://schemas.ipcommerce.com/CWS/v2.0/Transactions/Bankcard")
public class PINDebitSaleTotals {
